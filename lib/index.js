...
function outdated(config, testedVersion, latestVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        const issues = yield (0, octokit_1.octokit)()
            .rest.issues.listForRepo(Object.assign(Object.assign({}, repo_1.repo), { creator: "github-actions[bot]", labels: "wpvc" }))
            .catch(function (e) {
        ...
        if (issues.data.length === 0) {
            ...
            yield (0, issue_management_1.updateIssue)(issues.data[0].number, testedVersion, latestVersion);
        }
    });
}
function upToDate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const issue of issues.data) {
            void (0, octokit_1.octokit)().rest.issues.update(Object.assign(Object.assign({}, repo_1.repo), { issue_number: issue.number, state: "closed" }));
        }
    });
}
function run() {
