...
function createIssue(testedVersion, latestVersion) {
    const args = Object.assign(Object.assign({}, repo), { title: "The plugin hasn't been tested with the latest version of WordPress", body: issueBody(testedVersion, latestVersion), labels: ['wpvc'] });
...
function updateIssue(issue, testedVersion, latestVersion) {
    octokit.issues.get(Object.assign(Object.assign({}, repo), { issue_number: issue })).then(function (result) {
        ...
        if (compare_versions_1.default.compare(latestVersionInIssue, latestVersion, '<')) {
            octokit.issues.update(Object.assign(Object.assign({}, repo), { issue_number: issue, body: issueBody(testedVersion, latestVersion) })).catch(function (e) {
