...
function readme() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const readmeLocation of readmeLocations) {
            const result = yield octokit_1.octokit.repos
                .getContent(Object.assign(Object.assign({}, repo_1.repo), { path: readmeLocation }))
                .catch(function (e) {
                if (has_status_1.hasStatus(e) && e.status === 404) {
                    return null;
                }
                else {
...
function testedVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        const readmeContents = yield readme();
