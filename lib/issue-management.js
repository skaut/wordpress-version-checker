...
function createIssue(config, testedVersion, latestVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        yield (0, octokit_1.octokit)()
            .rest.issues.create(Object.assign(Object.assign({}, repo_1.repo), { title: "The plugin hasn't been tested with the latest version of WordPress", body: issueBody(testedVersion, latestVersion), labels: ["wpvc"], assignees: config !== null ? config.assignees : undefined }))
            .catch(function (e) {
...
function updateIssue(issueNumber, testedVersion, latestVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        const issue = yield (0, octokit_1.octokit)()
            .rest.issues.get(Object.assign(Object.assign({}, repo_1.repo), { issue_number: issueNumber }))
            .catch(function (e) {
        ...
        if (compare_versions_1.default.compare(latestVersionInIssue, latestVersion, "<")) {
            (0, octokit_1.octokit)()
                .rest.issues.update(Object.assign(Object.assign({}, repo_1.repo), { issue_number: issueNumber, body: issueBody(testedVersion, latestVersion) }))
                .catch(function (e) {
