...
function createIssue(testedVersion, latestVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        yield octokit_1.octokit.issues
            .create(Object.assign(Object.assign({}, repo_1.repo), { title: "The plugin hasn't been tested with the latest version of WordPress", body: issueBody(testedVersion, latestVersion), labels: ["wpvc"] }))
            .catch(function (e) {
